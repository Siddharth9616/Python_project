...
lb_mn_txt = Label(clk, text = "MINUTE", font= ("Time 20 bold", 20,"bold"),bg = "#00BEA4", fg= "white")
lb_mn_txt.place(x=520, y= 360, width=150,height=50)

lb_sc= Label(clk, text="12", font=("Times 20 bold", 75, 'bold'), bg = "#0684B8", fg="white")
lb_sc.place(x=690,y=200,width= 150, height=150)

lb_sc_txt = Label(clk, text = "MINUTE", font= ("Time 20 bold", 20,"bold"),bg = "#0684B8", fg= "white")
